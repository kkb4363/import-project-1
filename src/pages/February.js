...
const February = () => {
    ...
    const [holiday,setholiday] = useState([]);
       ...
       {/* 양,음력 api 받아오기 */}
       useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/LrsrCldInfoService/getLunCalInfo?numOfRows=31&solYear=2022&solMonth=02&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI/mxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG/QQQ==`)
        .then((res) => {
    ...
    {/* 특일 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?solYear=2022&solMonth=02&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI%2FmxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG%2FQQQ%3D%3D`)
        .then((res)=>{
    ...
    return(
        <div>
            ...
            <Header>
                ...
                <Link style={{marginLeft:'8px'}} to='/March'>
                ...
                <Yoil>
                    ...
                    <Week>  {/* 첫번째 주 */}
                        ...
                        <Day>
                            ...
                            <RedDay/>
                            <span>{data[0]?.solDay}</span>
                            <h5>{data[0]?.lunMonth}월{data[0]?.lunDay}일</h5>
                        </Day>
                        <Day>
                        <RedText>{holiday[1]?.dateName}</RedText>
                            <RedDay/>
                    ...
                    <Week> {/* 두번째 주 */}
                        <Day style={Weekend}>
                            ...
                            <h5>{data[5]?.lunMonth}월{data[5]?.lunDay}</h5>                        
                        </Day>
                        <Day>
                    ...
                    <Week> {/* 다섯번째 주 */}
                        ...
                        <Day>
                            <span style={Graytext}>3월 1일</span>
                        </Day>
                        <Day>
                        ...
                        <Day>
                            <span style={Graytext}>4</span>
                        </Day>
                        <Day style={Weekend}>
                            <span style={Graytext}>5</span>
                        </Day>
                    </Week>
            </main>
        </div>
