...
const May = () => {
    ...
    {/* 양,음력 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/LrsrCldInfoService/getLunCalInfo?numOfRows=31&solYear=2022&solMonth=05&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI/mxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG/QQQ==`)
        .then((res) => {
    ...
    {/* 특일 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?solYear=2022&solMonth=05&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI%2FmxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG%2FQQQ%3D%3D`)
        .then((res)=>{
    ...
    return(
        <div>
            ...
            <Header>
                <h5 style={{
                    color:'white',
                    fontSize:'16px'}}>2022년 5월
                </h5>

                <Link style={{marginLeft:'820px',marginRight:'8px'}} to='/April'>
                ...
                <Link style={{marginLeft:'8px'}} to='/June'>
            ...
            <main>
                <Yoil>
                    ...
                    <Week>
                        ...
                        <Day>
                        <RedText>{holiday[0]?.dateName}</RedText>                            <RedDay/>
                    ...
                    <Week>
                        <Day style={Weekend}>
                        <RedText>{holiday[1]?.dateName}</RedText>                            <RedDay/>
                    ...
                    <Week>
                        ...
                        <Day>
                            <span style={Graytext}>6월 1일</span>
                        </Day>
                        <Day>
