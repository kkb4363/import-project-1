            ...
            <main>
                <Yoil>
                    ...
                    <Week>
                        ...
                        <Day>
                            <RedText>어린이날</RedText>
                            <RedDay/>
                            <span>5</span></Day>
                        <Day><span>6</span></Day>
                        <Day style={Weekend}><span>7</span></Day>
                    </Week>
                    <Week>
                        <Day style={Weekend}>
                            <RedText>부처님 오신날</RedText>
                            <RedDay/>
                            <span>8</span>
                        </Day>
                        <Day>
                    ...
                    <Week>
                        ...
                        <Day><span style={Graytext}>6월 1일</span></Day>
                        <Day><span style={Graytext}>2</span></Day>
                        <Day><span style={Graytext}>3</span></Day>
                        <Day style={Weekend}><span style={Graytext}>4</span></Day>
                    </Week>
            </main>
        </div>
        )}
