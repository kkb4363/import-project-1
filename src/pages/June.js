...
const June = () => {
    ...
    {/* 양,음력 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/LrsrCldInfoService/getLunCalInfo?numOfRows=31&solYear=2022&solMonth=06&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI/mxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG/QQQ==`)
        .then((res) => {
    ...
    {/* 특일 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?solYear=2022&solMonth=06&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI%2FmxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG%2FQQQ%3D%3D`)
        .then((res)=>{
    ...
    return(
        <div>
            ...
            <Header>
                <h5 style={{
                    color:'white',
                    fontSize:'16px'}}>2022년 6월
                </h5>

                <Link style={{marginLeft:'820px',marginRight:'8px'}} to='/May'>
                ...
                <Link style={{marginLeft:'8px'}} to='/July'>
                ...
                <Yoil>
                    ...
                    <Week>
                        ...
                        <Day>
                            ...
                            <h5>{data[0]?.lunMonth}월{data[0]?.lunDay}일</h5>                        </Day>
                        <Day>
                    ...
                    <Week>
                        ...
                        <Day>
                            <span style={Graytext}>7월 1일</span>
                        </Day>
                        <Day style={Weekend}>
