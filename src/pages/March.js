...
const March = () => {
    ...
    {/* 양,음력 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/LrsrCldInfoService/getLunCalInfo?numOfRows=31&solYear=2022&solMonth=03&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI/mxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG/QQQ==`)
        .then((res) => {
    ...
    {/* 특일 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?solYear=2022&solMonth=03&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI%2FmxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG%2FQQQ%3D%3D`)
        .then((res)=>{
            ...
            <main>
                <Yoil>
                    ...
                    <Week>
                        ...
                        <Day>
                            <span style={Graytext}>4월 1일</span>
                        </Day>
                        <Day style={Weekend}>
