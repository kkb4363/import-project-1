...
const November = () => {
    ...
    {/* 양,음력 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/LrsrCldInfoService/getLunCalInfo?numOfRows=31&solYear=2022&solMonth=11&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI/mxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG/QQQ==`)
        .then((res) => {
    ...
    {/* 특일 api 받아오기 */}
    useEffect(()=>{
        axios.get(`https://apis.data.go.kr/B090041/openapi/service/SpcdeInfoService/getHoliDeInfo?solYear=2022&solMonth=11&ServiceKey=ziROfCzWMmrKIseBzkXs58HpS39GI%2FmxjSEmUeZbKwYuyxnSc2kILXCBXlRpPZ8iam5cqwZqtw6db7CnWG%2FQQQ%3D%3D`)
        .then((res)=>{
    ...
    return(
        <div>
            ...
            <Header>
                <h5 style={{
                    color:'white',
                    fontSize:'16px'}}>2022년 11월
                </h5>

                <Link style={{marginLeft:'811px',marginRight:'8px'}} to='/October'>
                ...
                <Link style={{marginLeft:'8px'}} to='/December'>
            ...
            <main>
                <Yoil>
                    ...
                    <Week>
                        ...
                        <Day>
                            <span style={Graytext}>12월 1일</span>
                        </Day>
                        <Day>
